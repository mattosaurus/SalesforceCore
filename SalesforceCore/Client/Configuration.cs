...
namespace SalesforceCore.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = $"{SdkName}/{LanguageName}/{Version}/{RuntimeInformationProvider.ClientEnvironmentRuntimeInformation}";
        ...
        public Configuration(
            ...
            string basePath = "https://www.exacttargetapis.com") : this()
        {
        ...
        {
            String report = "C# SDK (SalesforceCore) Debug Report:\n";

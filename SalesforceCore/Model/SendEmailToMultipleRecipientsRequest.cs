...
namespace SalesforceCore.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendEmailToMultipleRecipientsRequest :  IEquatable<SendEmailToMultipleRecipientsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendEmailToMultipleRecipientsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SendEmailToMultipleRecipientsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SendEmailToMultipleRecipientsRequest" /> class.
        /// </summary>
        ...
        public SendEmailToMultipleRecipientsRequest(string definitionKey = default(string), List<Recipient> recipients = default(List<Recipient>), Attributes attributes = default(Attributes))
        {
            // to ensure "definitionKey" is required (not null)
            if (definitionKey == null)
            {
                throw new InvalidDataException("definitionKey is a required property for SendEmailToMultipleRecipientsRequest and cannot be null");
            }
            else
            {
            ...
            if (recipients == null)
            {
                throw new InvalidDataException("recipients is a required property for SendEmailToMultipleRecipientsRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SendEmailToMultipleRecipientsRequest);
        }

        /// <summary>
        /// Returns true if SendEmailToMultipleRecipientsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SendEmailToMultipleRecipientsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendEmailToMultipleRecipientsRequest input)
        {
            if (input == null)
                return false;

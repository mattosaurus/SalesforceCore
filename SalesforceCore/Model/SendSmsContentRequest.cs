...
namespace SalesforceCore.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendSmsContentRequest :  IEquatable<SendSmsContentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendSmsContentRequest" /> class.
        /// </summary>
        ...
        public SendSmsContentRequest(string message = default(string))
        {
        ...
        {
            return this.Equals(input as SendSmsContentRequest);
        }

        /// <summary>
        /// Returns true if SendSmsContentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SendSmsContentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendSmsContentRequest input)
        {
            if (input == null)
                return false;
